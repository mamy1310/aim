  ...
  return (
    <Box component="form" onSubmit={submit} noValidate sx={{ display: "grid", gap: 2 }}>
      ...
      <PasswordField
        ...
        onChange={(v) => {
          setPassword(v);
          setErrors((e) => ({ ...e, password: undefined, confirm: confirm && confirm === v ? undefined : e.confirm }));
        }}
      ...
      <Box
        ...
        sx={{
          ...
          lineHeight: 1.45,
          "& a": { color: "text.primary", borderBottom: "1px solid", borderColor: "divider", "&:hover": { borderColor: "text.disabled" } },
        }}
      >
        <Checkbox
          checked={terms}
