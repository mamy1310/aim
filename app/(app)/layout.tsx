    ...
    <>
      ...
      >
        ...
        >
          <Box component="span">
            {t("footer.copyright")} ·{" "}
            {t("footer.signedInAs", { name: currentUser.name })}
          </Box>
          <Box sx={{ display: "flex", flexWrap: "wrap", gap: 2.25 }}>
            <Link href="/account" underline="none" sx={{ color: "text.secondary", "&:hover": { color: "text.primary" } }}>
              {t("footer.account")}
            </Link>
            <Link href="/aide" underline="none" sx={{ color: "text.secondary", "&:hover": { color: "text.primary" } }}>
              {t("footer.help")}
            </Link>
            <Link href="/logout" underline="none" sx={{ color: "text.secondary", "&:hover": { color: "text.primary" } }}>
              {t("footer.logout")}
            </Link>
          </Box>
        </Box>
