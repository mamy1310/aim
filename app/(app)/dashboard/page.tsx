...
const newsletter = { status: "none" as "none" | "active" | "issue" };
    ...
    <Box component="main">
              ...
              {courses.map((crs) => (
                ...
                >
                  ...
                  >
                    ...
                    <Typography component="h3" sx={{ ...serif, fontSize: "19px", fontWeight: 500, lineHeight: 1.2 }}>
                      {crs.title}
                    </Typography>
                    <Box
                      sx={{
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1.25, mt: 0.5 }}>
                      ...
                      <Box component="span" sx={{ ...mono, fontSize: "11px", letterSpacing: "0.04em", color: "secondary.main" }}>
        ...
        <Box component="section" id="mes-badges" sx={blockSx}>
          <Box sx={wrap}>
            ...
            >
              <Typography variant="h2" component="h2" sx={{ fontSize: "clamp(1.375rem, 3.5vw, 1.625rem)" }}>
                {t("badges.title")}
              </Typography>
              <Box component="span" sx={{ ...mono, fontSize: "11.5px", letterSpacing: "0.04em", color: "text.disabled" }}>
            ...
            >
              {badges.map((b) => (
                ...
                >
                  ...
                  >
                    <Box sx={{ position: "absolute", inset: "14%", borderRadius: "6px", overflow: "hidden" }}>
                  ...
                  <Box component="span" sx={{ ...serif, fontSize: "14px", lineHeight: 1.25, letterSpacing: "-0.005em", color: "text.primary", textWrap: "balance" }}>
                    {b.title}
                  </Box>
                  <Box component="span" sx={{ ...mono, fontSize: "10.5px", letterSpacing: "0.05em", color: "text.disabled" }}>
                    {b.date}
                  </Box>
                </Link>
              ))}
        ...
        <Box component="section" id="newsletter" sx={blockSx}>
          <Box sx={wrap}>
            <Typography variant="h2" component="h2" sx={{ fontSize: "clamp(1.375rem, 3.5vw, 1.625rem)", mb: 2.5 }}>
              {t("newsletter.title")}
            </Typography>
            ...
            >
              <Box>
                ...
                <Typography component="h3" sx={{ ...serif, fontSize: "22px", fontWeight: 500, letterSpacing: "-0.01em", mb: 0.75 }}>
          ...
          <Box sx={wrap}>
            ...
            >
              {actionItems.map((a, i) => (
                ...
                >
                  <Box component="span" sx={{ ...mono, fontSize: "11px", letterSpacing: "0.05em", color: "text.disabled" }}>
                    {String(i + 1).padStart(2, "0")}
                  </Box>
                  <Box sx={{ display: "grid", gap: "2px", minWidth: 0 }}>
                    <Box component="span" sx={{ fontSize: "15px", fontWeight: 500, color: "text.primary" }}>
                      {a.title}
                    </Box>
