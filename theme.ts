...
import type { Overlays, Shadows } from '@mui/material/styles';
...
const FONT_SERIF = 'var(--font-newsreader), "Newsreader", ui-serif, Georgia, serif';
const FONT_SANS =
  'var(--font-geist-sans), "Geist", ui-sans-serif, system-ui, -apple-system, "Segoe UI", sans-serif';
const FONT_MONO = 'var(--font-geist-mono), "Geist Mono", ui-monospace, "SF Mono", Menlo, monospace';
  ...
  colorSchemes: {
    light: {
      palette: {
        ...
        elevation1: '0 1px 0 oklch(0.91 0.004 240 / 0.6), 0 1px 2px oklch(0.2 0.01 250 / 0.04)',
        elevation2:
    ...
    dark: {
      palette: {
        ...
        elevation2: '0 1px 0 oklch(0.30 0.012 250 / 0.6), 0 1px 2px oklch(0 0 0 / 0.25)',
        elevation3:
      ...
      overlays: Array(25).fill('none') as string[] & Overlays,
    },
  },
